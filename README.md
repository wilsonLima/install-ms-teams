...
Role do Ansible com passos para a instalação do aplicativo Microsoft Teams.
...
- teams: Instala os pacotes do Microsoft Teams.
...
Exemplo de arquivo de hosts: pasta_invetario/hosts
    ...
    [NOME]
    IP ansible_connection=smart ansible_ssh_user=USUARIO ansible_ssh_pass=SENHA_URUARIO ansible_become_pass=SENHA_ROOT
